...
function generatePropertyCards() {
    ...
    // Display property cards if properties exist or not
...
function redirectToCreateProperty() {
    // Implement logic to redirect to the property creation page (e.g., createproperty.html)
...
function openUpdateForm() {
    ...
    // Implement logic to redirect to the update property page (e.g., updateproperty.html)
